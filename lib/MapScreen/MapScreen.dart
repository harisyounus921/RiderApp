...
class _MapScreenState extends State<MapScreen> {
  ...
  late double piclocationsCorditates,droplocationCordinates;
  late double picklatitude,picklongitude,droplatitude,droplongitude;

  CordinatesSelection(){
    Consumer<LatlongProvider>(
        builder: (context,LatlongProvider,child) {
          return LatLng(LatlongProvider.droplat, LatlongProvider.droplong)as Widget;
        });
  }
  ...
  List<String>images=['assets/pick.png','assets/current.png','assets/car_ac.png','assets/drop.png'];
