...
import 'package:driver_app_user/Splash/splash_screen.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void saveDriverInfoNow()async{
    ...
    if(firebaseUser!=null){
      ...
      DatabaseReference driverRef=FirebaseDatabase.instance.ref().child("user");
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Center(child: Text("User Register",style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold,color: Colors.grey),)),
